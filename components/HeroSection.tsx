...
import { ChevronLeft, ChevronRight, Sparkles, Calendar, BookOpen, Zap } from 'lucide-react'
...
const slides = [
  {
    ...
    description: "Experience transformative spiritual guidance and unlock your highest potential",
    gradient: "from-purple-900/80 via-indigo-900/80 to-blue-900/80"
  },
  {
    title: "Ancient Wisdom",
    subtitle: "Modern Insights",
    description: "Blend timeless spiritual practices with contemporary guidance for holistic growth",
    gradient: "from-indigo-900/80 via-purple-900/80 to-pink-900/80"
  },
  {
    title: "Healing Energy",
    subtitle: "Transform Your Life",
    description: "Harness the power of energy healing to restore balance and inner peace",
    gradient: "from-cyan-900/80 via-blue-900/80 to-indigo-900/80"
  },
  {
    title: "Your Journey Begins",
    subtitle: "Start Today",
    description: "Book your personal consultation and embark on a journey of spiritual awakening",
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
                <Link href="/appointments">
                  <Button variant="spiritual" size="lg" className="text-lg px-8 py-6">
                    Book Your Session
                  </Button>
                </Link>
                <Link href="/about">
